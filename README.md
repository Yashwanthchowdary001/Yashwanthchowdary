...
<p align="center">
  <img src="https://readme-typing-svg.herokuapp.com?size=21&duration=3000&center=true&vCenter=true&width=700&lines=Designing+Scalable+Data+Platforms;Real-Time+Streaming+%7C+LLMs+%7C+ML;Turning+Raw+Data+into+Decisions" />
</p>
...
AI Data Engineer with **4+ years of experience** designing and delivering **scalable data pipelines, real-time streaming systems, and ML-driven analytics platforms** across **AWS, Azure, and GCP**.

I specialize in building **cloud-native data architectures**, integrating **Kafka-based streaming**, enabling **LLM/RAG workflows**, and delivering **production-ready analytics and BI solutions**. Proven track record of reducing latency, improving data reliability, and supporting executive-level decision making.
...
📍 Austin, TX | **Jun 2024 – Present**

<p align="center">
  <img src="https://media.giphy.com/media/26tn33aiTi1jkl6H6/giphy.gif" width="480"/>
</p>

- Designed and optimized **enterprise-scale data pipelines** using AWS Glue, PySpark, Redshift, and Azure Data Lake  
- Processed **terabytes of data weekly**, improving data reliability by **40%+**  
- Integrated **Kafka-based real-time streaming**, reducing reporting latency by **60%**  
- Built predictive models and BI dashboards using **Python, SQL, Power BI, Snowflake**  
- Automated CI/CD pipelines and monitoring, reducing downtime by **30%**  
- Enabled **LLM-driven analytics and data workflows** for downstream AI use cases  

---

### 💊 Tata 1mg — *Data Engineer*  
📍 Bengaluru, India | **Jun 2020 – Jul 2022**

<p align="center">
  <img src="https://media.giphy.com/media/l0MYB8Ory7Hqefo9a/giphy.gif" width="480"/>
</p>

- Developed and maintained batch and streaming pipelines using **Spark, Hive, Kafka**  
- Supported large-scale analytics and reporting platforms  
- Improved pipeline performance and data quality across healthcare datasets  

---

### 🧩 OneAdvanced — *Data Analyst*  
📍 Hyderabad, India | **May 2019 – Dec 2019**

<p align="center">
  <img src="https://media.giphy.com/media/3oKIPEqDGUULpEU0aQ/giphy.gif" width="480"/>
</p>

- Built BI dashboards and analytical reports for business stakeholders  
- Performed SQL-based data analysis to support operational insights  
...
<p align="center">
  <img src="https://media.giphy.com/media/l0HlQ7LRalQqdWfao/giphy.gif" width="480"/>
</p>

- End-to-end rental platform with payments and maintenance workflows  
- Role-based access and cloud deployment  

**Tech:** React, FastAPI, PostgreSQL, AWS, Docker
...
- Fine-tuned BERT for symptom-based disease classification  
...
<p align="center">
  <img src="https://media.giphy.com/media/l0ExncehJzexFpRHq/giphy.gif" width="480"/>
</p>

- Analyzed CO₂ impact of training and inference of large language models  
- Built sustainability visualizations  
...
<p align="center">
  <img src="https://img.shields.io/badge/AWS%20Certified%20Data%20Engineer–Associate-232F3E?style=for-the-badge&logo=amazonaws"/>
  <img src="https://img.shields.io/badge/Microsoft%20Power%20BI%20Data%20Analyst-F2C811?style=for-the-badge&logo=powerbi&logoColor=black"/>
  <img src="https://img.shields.io/badge/Lloyds%20Banking%20Group–Data%20Science-005EB8?style=for-the-badge"/>
  <img src="https://img.shields.io/badge/Walmart–Advanced%20Software%20Engineering-0071CE?style=for-the-badge"/>
  <img src="https://img.shields.io/badge/IBM–Data%20Analysis%20with%20Python-052FAD?style=for-the-badge&logo=ibm"/>
</p>
